...
from vlfm.utils.my_colorama import Fore
class ObstacleMap(BaseMap):
    ...
    def __init__(
        ...
        print(Fore.YELLOW + f"[INFO]: Obstacle map - dimension [size={size}]")
        print(Fore.YELLOW + f"[INFO]: Obstacle map - pixels_per_meter [{pixels_per_meter}]")
